...
(() => {
  ...
  /* ==========================================================================
     06. SMART BLOB & INDEXEDDB PDF OPENER (FIXED SCHEME & MOBILE SUPPORT)
     ========================================================================== */
      ...
      if (notesPanelEmpty) {
        ...
        notesPanelEmpty.innerHTML = `
          <div class="empty-state-card" style="text-align: center; padding: 25px 15px;">
            <div style="font-size: 2.5rem; color: #94A3B8; margin-bottom: 10px;"><i class="fa-solid fa-folder-open"></i></div>
